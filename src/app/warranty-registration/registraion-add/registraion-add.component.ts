...
@Component({
  selector: 'app-registraion-add',
  templateUrl: './registraion-add.component.html',
  styleUrls: ['./registraion-add.component.scss']
})
export class RegistraionAddComponent implements OnInit {
  fabBtnValue: any = 'add';
