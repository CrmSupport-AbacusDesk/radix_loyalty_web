...
export class DistributionListComponent implements OnInit {
  ...
  downloadExcel() {
    ...
    this.serve.post_rqst({ 'search': this.value, 'type': this.type_id, 'filter': this.filter, 'type_name': this.type }, "Excel/battery_warranty_registration_excel").subscribe((result) => {
      if (result['msg'] == true) {
